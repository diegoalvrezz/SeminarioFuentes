...
defuncion_poblacion <- read_delim("./DATA/defuncion_poblacion.csv", delim =";")git 

#arboles_superficie <- read_delim("./Datos_arboles/provincia_superficie_altura.csv", delim = ";")

arboles_uso <- read_delim("./Datos_arboles/Arbolesusofinal.csv", delim = ";",show_col_types = FALSE)
...
```{r}
#library(imputeTS)
#arboles_uso <- na.replace (arboles_uso, 0)
